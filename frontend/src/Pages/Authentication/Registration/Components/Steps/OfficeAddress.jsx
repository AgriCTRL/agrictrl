...
const OfficeAddress = ({
    ...
    return (
        <StepWrapper
            ...
            subHeading="Enter your office address"
        >
            <div className="flex flex-col gap-2">
                <label htmlFor="region" className="block text-sm text-black">
                    Region
                </label>
                <Dropdown
                    id="region"
                ...
                {region !== "National Capital Region" && (
                    <div className="flex flex-col gap-2">
                        ...
                        <Dropdown
                            ...
                            onChange={(e) =>
                                handleInputChange("province", e.value)
                            }
                            placeholder="Select a province"
                            className="ring-0 w-full"
                            invalid={
                                !officeAddress.province && nextBtnIsClicked
                            }
                        />
                        {region &&
                            !province &&
