...
const LoginPage = () => {
    ...
    const { login } = useAuth();
    const [underverificationVisible, setUnderverificationVisible] =
        useState(false);
    ...
    const loginUser = async (email, password, userType) => {
        ...
        const identityLogIn = async () => {
            ...
            return new Promise((resolve, reject) => {
                authClient.login({
                    ...
                    onSuccess: resolve,
                    onError: () =>
                        reject(new Error("Failed to login internet identity.")),
        ...
        try {
                ...
                if (userType === "Admin") {
                    ...
                    if (newPrincipal) {
                        if (user.principal === null) {
                            ...
                            if (!res.ok) {
                                throw new Error(
                                    "Failed to update user principal"
                                );
                            }
                            ...
                            return {
                                success: false,
                                message: "Invalid internet identity",
                            };
                        }
                    } else {
                        return {
            ...
            return {
                success: false,
                message: "Invalid user type, email or password",
            };
        }
    };
        ...
        <div className="h-fit md:h-screen w-screen flex flex-col-reverse md:flex-row md:gap-10 p-0 md:p-10">
            ...
            <Dialog
                ...
                footer={
                    <Button
                        ...
                        label="Close"
                        onClick={() => setUnderverificationVisible(false)}
                    />
                }
                visible={underverificationVisible}
                onHide={() => {
                    if (!underverificationVisible) return;
                    setUnderverificationVisible(false);
                }}
            ...
            >
                <div className="flex flex-col gap-4 items-center justify-center text-center h-full">
                    ...
                    <p>
                        We are verifying your account for{" "}
            ...
            <div className="flex flex-col items-center justify-between h-full w-full md:w-[45%] p-10 gap-4 rounded-2xl">
                <div className="h-full w-full flex flex-col justify-start gap-6">
                    ...
                    <p className="text-md text-black">
                        Let's continue working together to build a sustainable
                        future for Philippine agriculture.
                    </p>
                ...
                <div className="relative z-20 w-full flex flex-col items-center justify-center h-full gap-8">
                    <div className="w-full flex flex-col gap-6">
                        <div className="text-center">
                            ...
                            <p className="text-md">
                                Revolutionizing Rice Supply Chain Transparency
                                and Traceability
                            </p>
                        </div>
