    ...
    return (
        <div className="flex items-center space-x-2 bg-primary text-white rounded-full">
            <Button
                ...
                onClick={() => navigate(-1)}
                className="p-button-text text-white ring-0"
                disabled={disabled}
            />
        ...
        <RecipientLayout activePage="History" user={user}>
            <div className="flex flex-col px-10 py-2 h-full bg-[#F1F5F9]">
                ...
                <div className="flex items-center space-x-4 p-4 rounded-lg mb-4">
                    <Button
                        label="All"
                        className={`text-sm md:text-base p-button-text bg-white rounded-md ring-0  ${
                            showAll
                                ? "bg-gradient-to-r from-primary to-secondary border-none text-white"
                                : ""
                        }`}
