  ...
  const handleUpdateRiceBatch = async () => {
    ...
    try {
      const response = await fetch(
        `${apiUrl}/ricebatches/update?id=${selectedItem.id}`,
        {
          method: "POST",
          headers: {
    ...
    <>
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-2">
              <label htmlFor="currentCapacity" className="font-medium">
                Current Capacity (bags)
              </label>
              <InputNumber
                id="currentCapacity"
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="receivedOn" className="font-medium">
                Date Received
              </label>
              <InputText
                id="receivedOn"
