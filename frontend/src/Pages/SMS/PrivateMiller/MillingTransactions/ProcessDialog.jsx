        ...
        <>
            ...
            >
                <div className="flex flex-col gap-2 md:gap-4">
                    ...
                    <div className="w-full">
                        <label className="block mb-2 text-xs md:text-sm text-black">
                    ...
                    <div className="text-xs md:text-sm text-yellow-600 mt-2">
                        Note: Only 63% of the milled bags will be recorded in
                        the system.
                    </div>
                    ...
                    <div className="flex justify-between gap-2 md:gap-4 mt-2 md:mt-4">
                        ...
                        <Button
                            ...
                            className="w-1/2 bg-primary hover:border-none text-xs md:text-sm"
