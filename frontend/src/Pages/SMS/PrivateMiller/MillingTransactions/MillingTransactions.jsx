...
const MillingTransactions = () => {
        ...
        try {
            ...
            if (palayStatus.length > 0) {
                palayStatus.forEach((status) =>
                    params.append("palayStatus", status)
                );
            }
            ...
            // Fetch data
            const [facilitiesRes, inventoryRes, warehousesRes] =
                await Promise.all([
    ...
    const FilterButton = ({ label, icon, filter }) => (
        <Button
            label={label}
            icon={icon}
            className={`p-2 md:p-4 py-0 p-button-sm text-sm ring-0 border-none rounded-full gap-2 ${
    ...
    const itemTemplate = (item) => {
        return (
            <div className="col-12" onClick={() => handleItemClick(item)}>
                <div className="flex flex-row items-center p-2 md:p-4 gap-2 md:gap-4 cursor-pointer bg-gray-100 hover:bg-gray-200 rounded-lg mb-2 md:mb-4">
                    {/* Left Side - Icon */}
                    <div className="flex-none">
                        <Wheat className="text-light-grey size-8 md:size-10" />
                    </div>

                    {/* Middle - Main Info */}
                    <div className="flex-1 gap-1 text-black">
                        ...
                        <div className="flex items-center">
                            <span className="py-1 text-xs md:text-sm">
                    ...
                    <div className="overflow-hidden bg-white flex flex-col gap-4 p-2 md:p-4 rounded-lg">
                        <div className="flex justify-between items-center">
                            <div className="hidden md:flex bg-white rounded-full gap-2">
                                ...
                                <FilterButton
                                    label="In Milling"
                                    icon={
                                        <Factory className="size-4 md:size-5" />
                                    }
                                    filter="process"
                                />
                                <FilterButton
                            ...
                            <Dropdown
                                ...
                                options={[
                                    ...
                                    { label: "In Milling", value: "process" },
                        ...
                        >
                            <DataView
                                ...
                                onPage={onPage}
                                emptyMessage={
                                    <EmptyRecord label="No milling data to show." />
                                }
