        ...
        <form className="space-y-4 flex flex-col">
            <div className="flex flex-row mb-10">
                <div className="mr-5">
                    ...
                    <InputText id="firstName" placeholder="enter your first name" className="Normal border rounded-lg w-full h-10 pl-3 pr-3 mt-2" />
                </div>
                <div>
                    <label htmlFor="lastName" className="">Last Name</label>
                    <InputText id="lastName" placeholder="enter your last name" className="Normal border rounded-lg w-full h-10 pl-3 pr-3 mt-2" />
                </div>
            </div>
