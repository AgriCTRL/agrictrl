...
export async function getTransactionByToLocationId(
  toLocationId: string,
  toLocationType?: string
...
export async function createTransaction(
  ...
  transaction.transporterId = transactionCreate.transporterId;
...
export async function updateTransaction(
  ...
  await Transaction.update(transactionUpdate.id, {
    ...
    transporterId: transactionUpdate.transporterId,
  });
